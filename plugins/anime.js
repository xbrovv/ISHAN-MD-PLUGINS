...
cmd(
  ...
  async (ishan, mek, m, { from, reply }) => {
    ...
    await ishan.sendMessage(from, { text: `💬 "${data.quote}"\n- ${data.character} (${data.anime})` }, { quoted: mek });
  }
);
...
cmd(
  ...
  async (ishan, mek, m, { from }) => {
    ...
    await ishan.sendMessage(from, { image: { url: data.url }, caption: "💌 Waifu Quote" }, { quoted: mek });
  }
);
...
cmd(
  ...
  async (ishan, mek, m, { from }) => {
    ...
    await ishan.sendMessage(from, { text: `🤔 *Anime Fact:* ${fact}` }, { quoted: mek });
  }
);
...
cmd(
  ...
  async (ishan, mek, m, { from }) => {
    ...
    await ishan.sendMessage(from, { text: `❓ *Quiz:* ${selected.q}\n_Answer: ${selected.a}_` }, { quoted: mek });
  }
);
...
cmd(
  ...
  async (ishan, mek, m, { from }) => {
    ...
    await ishan.sendMessage(from, { video: { url: gif }, caption: "🎲 Anime Roll" }, { quoted: mek });
  }
);
...
cmd(
  ...
  async (ishan, mek, m, { from }) => {
    ...
    await ishan.sendMessage(from, { image: { url: selected.url }, caption: "🎮 Guess this character!" }, { quoted: mek });
  }
);
